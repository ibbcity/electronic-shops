...
import com.example.alphashopproject.ui.my_account.MyAccountFragment;
import com.example.alphashopproject.ui.my_cart.MyCartFragment;
import com.example.alphashopproject.ui.alpha.alphalFragment;
import com.example.alphashopproject.ui.my_orders.MyOrdersFragment;
...
import static com.example.alphashopproject.R.*;
...
public class MainActivity extends AppCompatActivity {
    ...
    private static final int MyMallFragment=0,CART_FRAGMENT=1,ORDERS_FRAGMENT=2,WISHLIST_FRAGMENT=3,REWARDS_FRAGMENT=4,MYACCOUNT_FRAGMENT=5,SETTING_FRAGMENT=6;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(showCart){
            ...
            setFragment(new alphalFragment(), MyMallFragment);
                        ...
                        public void onDrawerClosed(View drawerView) {
                            ...
                            if (id == R.id.nav_my_mall) {
                                ...
                                try {
                                    ...
                                    Toast.makeText(MainActivity.this,"erore in order",Toast.LENGTH_SHORT).show();
                                }
                            } else if (id == R.id.nav_my_rewards) {
                                try {
                                    gotoFragment("My Rewards", new MyRewardsFragment(), REWARDS_FRAGMENT);
                                }catch (Exception e){
                                    Toast.makeText(MainActivity.this,"erore in Roward",Toast.LENGTH_SHORT).show();
                                }
                                ...
                                try {
                                    ...
                                    Toast.makeText(MainActivity.this,"erore in cart",Toast.LENGTH_SHORT).show();
                                }
                            } else if (id == R.id.nav_my_wishlist) {
                                try {
                                    gotoFragment("My Wishlist", new MyWishlistFragment(), WISHLIST_FRAGMENT);
                                }catch (Exception e){
                                    Toast.makeText(MainActivity.this,"erore in wishlist",Toast.LENGTH_SHORT).show();
                                }
                            } else if (id == R.id.nav_my_account) {
                                try {
                                    gotoFragment("My Account", new MyAccountFragment(), MYACCOUNT_FRAGMENT);
                                }catch (Exception e){
                                    Toast.makeText(MainActivity.this,"erore in my account",Toast.LENGTH_SHORT).show();
                                }
                            }else if(id == R.id.nav_my_setting){
                                try {
                                    gotoFragment("My Setting",new SettingFragment(),SETTING_FRAGMENT);
                                }catch (Exception e){
                                    Toast.makeText(MainActivity.this,"erore in my Setting",Toast.LENGTH_SHORT).show();
                                }
                            }
                                ...
                                try {
                                    ...
                                    Toast.makeText(MainActivity.this,"erore in my sign out",Toast.LENGTH_SHORT).show();
                                }
