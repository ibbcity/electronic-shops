...
import com.example.alphashopproject.ui.my_cart.MyCartFragment;
import com.example.alphashopproject.ui.alpha.alphalFragment;
import com.example.alphashopproject.ui.my_rewards.MyRewardsFragment;
import com.example.alphashopproject.ui.my_wishlist.MyWishlistFragment;
...
import static com.example.alphashopproject.ProductDetailsActivity.addToWishlistBtn;
import static com.example.alphashopproject.R.string.*;
import static com.example.alphashopproject.R.string.ar;
//import static com.example.alphashopproject.ui.my_setting.SettingFragment.language;
...
public class DBquerries {
    ...
    public static List<List<alphalModel>> lists=new ArrayList<>();
                    ...
                    public void onComplete(@NonNull Task<QuerySnapshot> task) {
                        if(task.isSuccessful()){
                            ...
                            for(QueryDocumentSnapshot queryDocumentSnapshot : task.getResult()){
                                if(context.getString(R.string.language).equals("english")) {
                                ...
                                }if(context.getString(R.string.language).equals("arabic")) {
                                    if(queryDocumentSnapshot.get("categoryName").toString().equals("Home")){
                                        categoryModelList.add(new CategoryModel(queryDocumentSnapshot.get("icon").toString(),context.getString(homes) ));
                                    }
                                    else if(queryDocumentSnapshot.get("categoryName").toString().equals("Electronics")){
                                        categoryModelList.add(new CategoryModel(queryDocumentSnapshot.get("icon").toString(),context.getString(elctironics) ));
                                    }
                                    else if(queryDocumentSnapshot.get("categoryName").toString().equals("Furniture")){
                                        categoryModelList.add(new CategoryModel(queryDocumentSnapshot.get("icon").toString(),context.getString(Furnitur) ));
                                    }
                                    else if(queryDocumentSnapshot.get("categoryName").toString().equals("Fashion")){
                                        categoryModelList.add(new CategoryModel(queryDocumentSnapshot.get("icon").toString(),context.getString(Fashion) ));
                                    }else if(queryDocumentSnapshot.get("categoryName").toString().equals("Books")){
                                        categoryModelList.add(new CategoryModel(queryDocumentSnapshot.get("icon").toString(),context.getString(Books) ));
                                    }else if(queryDocumentSnapshot.get("categoryName").toString().equals("Sports")){
                                        categoryModelList.add(new CategoryModel(queryDocumentSnapshot.get("icon").toString(),context.getString(Sports) ));
                                    }else if(queryDocumentSnapshot.get("categoryName").toString().equals("Toys")){
                                        categoryModelList.add(new CategoryModel(queryDocumentSnapshot.get("icon").toString(),context.getString(Toys) ));
                                    }
                                    else if(queryDocumentSnapshot.get("categoryName").toString().equals("Shoes")){
                                        categoryModelList.add(new CategoryModel(queryDocumentSnapshot.get("icon").toString(),context.getString(Shoes) ));
                                    }else if(queryDocumentSnapshot.get("categoryName").toString().equals("Accessories")){
                                        categoryModelList.add(new CategoryModel(queryDocumentSnapshot.get("icon").toString(),context.getString(Accessories) ));
                                    }
                                }
                            }
    ...
    public static void loadFragmentData(final RecyclerView myMallRecyclerView, final Context context, final int index, String categoryName) {
        firebaseFirestore.collection("CATEGORIES")
                ...
                .collection("TOP_DEALSCloneCloneCloneCloneCloneClone").orderBy("index").get()
                .addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
                    @Override
                    public void onComplete(@NonNull Task<QuerySnapshot> task) {
                        if (task.isSuccessful()) {
                            for (QueryDocumentSnapshot queryDocumentSnapshot : task.getResult()) {
                                if ((long) queryDocumentSnapshot.get("view_type") == 0) {
                                    ...
                                    for (long x = 1; x <= no_of_banners; x++) {
                                        sliderModelList.add(new SliderModel(queryDocumentSnapshot.get("banner_" + x).toString(), queryDocumentSnapshot.get("banner_" + x + "_backgound").toString()));
                                    }
                                    lists.get(index).add(new alphalModel(0, sliderModelList));

                                }

                                if ((long) queryDocumentSnapshot.get("view_type") == 1) {

                                    lists.get(index).add(new alphalModel(1, queryDocumentSnapshot.get("strip_ad_banner").toString(), queryDocumentSnapshot.get("background").toString()));

                                }

                                if ((long) queryDocumentSnapshot.get("view_type") == 2) {
                                    ...
                                    for (long x = 1; x <= no_of_products; x++) {
                                        ...
                                        horizontalProductScrollModelList.add(new HorizontalProductScrollModel(
                                                ...
                                                , queryDocumentSnapshot.get("product_title_" + x + context.getString(ar)).toString()
                                                , queryDocumentSnapshot.get("product_subtitle_" + x + context.getString(ar)).toString()
                                                , queryDocumentSnapshot.get("product_price_" + x + context.getString(ar)).toString()
                                        ));
                                        ...
                                        viewAllProductList.add(new WishlistModel(
                                                queryDocumentSnapshot.get("product_ID_" + x).toString()
                                                , queryDocumentSnapshot.get("product_image_" + x).toString()
                                                , queryDocumentSnapshot.get("product_full_title_" + x + context.getString(ar)).toString()
                                                , (long) queryDocumentSnapshot.get("free_coupens_" + x)
                                                , queryDocumentSnapshot.get("average_rating_" + x + context.getString(ar)).toString()
                                                , (long) queryDocumentSnapshot.get("total_ratings_" + x)
                                                , queryDocumentSnapshot.get("product_price_" + x + context.getString(ar)).toString()
                                                , queryDocumentSnapshot.get("cutted_price_" + x + context.getString(ar)).toString()
                                                , (boolean) queryDocumentSnapshot.get("COD_" + x)
                                                , (boolean) queryDocumentSnapshot.get("in_stock_" + x)
                                        ));

                                    }
                                    lists.get(index).add(new alphalModel(2, queryDocumentSnapshot.get(context.getString(layout_titlear)).toString(), queryDocumentSnapshot.get("layout_background").toString(), horizontalProductScrollModelList, viewAllProductList));

                                }
                                if ((long) queryDocumentSnapshot.get("view_type") == 3) {
                                    ...
                                    lists.get(index).add(new alphalModel(3, queryDocumentSnapshot.get(context.getString(layout_titlear)).toString(), queryDocumentSnapshot.get("layout_background").toString(), gridProductScrollModelList));
                                }

                            }
                            alphaAdapter alphaAdapter = new alphaAdapter(lists.get(index));
                            myMallRecyclerView.setAdapter(alphaAdapter);
                            alphaAdapter.notifyDataSetChanged();
                            alphalFragment.swipeRefreshLayout.setRefreshing(false);
                        } else {
                            String error = task.getException().getMessage();
                            Toast.makeText(context, error, Toast.LENGTH_SHORT).show();
                        }
                                                                        ...
                                                                        if (task.isSuccessful()) {
                                                                            if (task.getResult().getDocuments().size() < (long) documentSnapshot.get("stock_quantity")) {
                                                                                wishlistModelList.add(new WishlistModel(
                                                                                        ...
                                                                                        , documentSnapshot.get(context.getString(product_titles)).toString()
                                                                                        , (long) documentSnapshot.get("free_coupens")
                                                                                        , documentSnapshot.get(context.getString(average)).toString()
                                                                                        , (long) documentSnapshot.get("total_ratings")
                                                                                        , documentSnapshot.get(context.getString(product_prices)).toString()
                                                                                        , documentSnapshot.get(context.getString(cutted_prices)).toString()
        ...
        firebaseFirestore.collection("USERS").document(FirebaseAuth.getInstance().getUid())
            ...
            public void onComplete(@NonNull Task<Void> task) {
                if (task.isSuccessful()) {
                    ...
                    ProductDetailsActivity.ALREADY_ADDED_TO_WISHLIST = false;
                    Toast.makeText(context, Removed_Successfully, Toast.LENGTH_SHORT).show();
                } else {

                    if (addToWishlistBtn != null) {
                        addToWishlistBtn.setSupportImageTintList(context.getResources().getColorStateList(R.color.coupanRed));
                    }
                    addToWishlistBtn.setSupportImageTintList(context.getResources().getColorStateList(R.color.coupanRed));
