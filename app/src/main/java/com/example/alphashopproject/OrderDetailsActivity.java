...
//        cancelDialog.getWindow().setLayout(ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.WRAP_CONTENT);
        ...
        qty.setText("Qty :"+ model.getProductQuantity());
        ...
        switch (model.getOrderStatus()){
            case "Ordered":
                ...
                orderedDate.setText(simpleDateFormat.format(model.getOrderedDate()));
            ...
            case "Packed":
                ...
                packedDate.setText(simpleDateFormat.format(model.getPackedDate()));
            ...
            case "Shipped":
                ...
                shippedDate.setText(simpleDateFormat.format(model.getShippedDate()));
            ...
            case "out for Delivery":
                ...
                deliveredDate.setText(simpleDateFormat.format(model.getDelveredDate()));
        ...
        if(model.getDeliveryPrice().equals("FREE")){
            ...
            totalAmount.setText("Rs."+ (totalPrice + Long.valueOf(model.getDeliveryPrice())) +"/-");
        }
