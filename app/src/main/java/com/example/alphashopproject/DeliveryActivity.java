...
import static com.example.alphashopproject.AddAddressActivity.getphonenumber;
...
//                                        Toast.makeText(getApplicationContext(), "Payment Transaction response " + bundle.toString(), Toast.LENGTH_LONG).show();
        ...
        requestQueue.add(stringRequest);
        */
        Intent viewweb = new Intent(Intent.ACTION_VIEW, Uri.parse("https://www.google.com"));
    ...
    private void cod(){
        try {
            ...
            //smsManager.sendTextMessage("734026540",null, "12345", null, null);
            ...
            Toast.makeText(DeliveryActivity.this,"erore in my sendmasseg",Toast.LENGTH_SHORT).show();
        }
