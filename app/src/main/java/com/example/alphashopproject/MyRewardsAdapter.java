...
public class MyRewardsAdapter extends RecyclerView.Adapter<MyRewardsAdapter.Viewholder> {
    ...
    public class Viewholder extends RecyclerView.ViewHolder {
        ...
        private final TextView coupanTitle;
        private final TextView coupanExpiryDate;
        private final TextView coupanBody;
                        ...
                        if(!alreadyUsed) {
                            ...
                            if (productOriginalPrice > Long.valueOf(lowerLimit) && productOriginalPrice < Long.valueOf(upperLimit)) {
                                if (type.equals("Discount")) {
                                    ...
                                    discountedPrice.setText("Rs." + (productOriginalPrice - discountAmount) + "/-");
                                } else {
                                    discountedPrice.setText("Rs." + (productOriginalPrice - Long.valueOf(discORamt)) + "/-");
