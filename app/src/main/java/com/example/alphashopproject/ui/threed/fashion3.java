...
public class fashion3 extends Activity {
    public static String image;
    fashion3.view_bookes1 view;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        view = new fashion3.view_bookes1(this);
...
//	float touchedY = 0;
         ...
         */
        public Cubere_bookes1(fashion3.view_bookes1 view_bookes1)
        {
...
//		// Position the eye behind the origin.
            ...
            if (mProgramHandle != 0)
            {
                ...
                mTextureDataHandle0 = loadTexture(mActivityContext, R.mipmap.fashion3);
                mTextureDataHandle1 = loadTexture(mActivityContext, R.mipmap.fashion3);
                mTextureDataHandle2 = loadTexture(mActivityContext, R.mipmap.fashion3);
                mTextureDataHandle3 = loadTexture(mActivityContext, R.mipmap.fashion3);
                mTextureDataHandle4 = loadTexture(mActivityContext, R.mipmap.fashion3);
                mTextureDataHandle5 = loadTexture(mActivityContext, R.mipmap.fashion3);
...
//*each face of the cube is drawn using 2 triangles. so 2*3=6 lines
    ...
    public class view_bookes1 extends GLSurfaceView {
        ...
        float touchedX = 0;
        float touchedY = 0;
        com.example.alphashopproject.ui.threed.fashion3.Cubere_bookes1 renderer;
        public view_bookes1(Context context) {
            super(context);
            setEGLContextClientVersion(2);
            setRenderer(renderer = new com.example.alphashopproject.ui.threed.fashion3.Cubere_bookes1(this));
        }
