...
public class bookes1 extends Activity {
...
//	float touchedY = 0;
         ...
         */
        public Cubere_bookes1(view_bookes1 view_bookes1)
        {
...
//*each face of the cube is drawn using 2 triangles. so 2*3=6 lines
    ...
    public class view_bookes1 extends GLSurfaceView {
        ...
        float touchedX = 0;
        float touchedY = 0;
        com.example.alphashopproject.ui.threed.bookes1.Cubere_bookes1 renderer;
        public view_bookes1(Context context) {
            super(context);
            setEGLContextClientVersion(2);
            setRenderer(renderer = new com.example.alphashopproject.ui.threed.bookes1.Cubere_bookes1(this));
        }
