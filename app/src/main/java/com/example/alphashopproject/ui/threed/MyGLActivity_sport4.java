...
public class MyGLActivity_sport4 extends Activity {
    public static String image;
    MyGLActivity_sport4.view_MyGLActivity_sport4 view;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        view = new MyGLActivity_sport4.view_MyGLActivity_sport4(this);
    ...
    public static class Cubere_MyGLActivity_sport4 implements GLSurfaceView.Renderer {
...
//	float touchedY = 0;
         ...
         */
        public Cubere_MyGLActivity_sport4(MyGLActivity_sport4.view_MyGLActivity_sport4 view_MyGLActivity_sport4)
        {
            mActivityContext = view_MyGLActivity_sport4;
...
//*each face of the cube is drawn using 2 triangles. so 2*3=6 lines
    ...
    public class view_MyGLActivity_sport4 extends GLSurfaceView {

        float touchedX = 0;
        float touchedY = 0;
        com.example.alphashopproject.ui.threed.MyGLActivity_sport4.Cubere_MyGLActivity_sport4 renderer;
        public view_MyGLActivity_sport4(Context context) {
            super(context);
            setEGLContextClientVersion(2);
            setRenderer(renderer = new com.example.alphashopproject.ui.threed.MyGLActivity_sport4.Cubere_MyGLActivity_sport4(this));
        }
