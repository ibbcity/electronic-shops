...
public class MyGLActivity_shoes2 extends Activity {
    public static String image;
    MyGLActivity_shoes2.view_MyGLActivity_shoes2 view;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        view = new MyGLActivity_shoes2.view_MyGLActivity_shoes2(this);
    ...
    public static class Cubere_MyGLActivity_shoes2 implements GLSurfaceView.Renderer {
...
//	float touchedY = 0;
         ...
         */
        public Cubere_MyGLActivity_shoes2(MyGLActivity_shoes2.view_MyGLActivity_shoes2 view_MyGLActivity_shoes2)
        {
            mActivityContext = view_MyGLActivity_shoes2;
...
//		// Position the eye behind the origin.
            ...
            if (mProgramHandle != 0)
            {
                ...
                mTextureDataHandle0 = loadTexture(mActivityContext, R.mipmap.shoes2);
                mTextureDataHandle1 = loadTexture(mActivityContext, R.mipmap.shoes2);
                mTextureDataHandle2 = loadTexture(mActivityContext, R.mipmap.shoes2);
                mTextureDataHandle3 = loadTexture(mActivityContext, R.mipmap.shoes2);
                mTextureDataHandle4 = loadTexture(mActivityContext, R.mipmap.shoes2);
                mTextureDataHandle5 = loadTexture(mActivityContext, R.mipmap.shoes2);
...
//*each face of the cube is drawn using 2 triangles. so 2*3=6 lines
    ...
    public class view_MyGLActivity_shoes2 extends GLSurfaceView {

        float touchedX = 0;
        float touchedY = 0;
        com.example.alphashopproject.ui.threed.MyGLActivity_shoes2.Cubere_MyGLActivity_shoes2 renderer;
        public view_MyGLActivity_shoes2(Context context) {
            super(context);
            setEGLContextClientVersion(2);
            setRenderer(renderer = new com.example.alphashopproject.ui.threed.MyGLActivity_shoes2.Cubere_MyGLActivity_shoes2(this));
        }
