...
public class MyGLActivity_sport1 extends Activity {
    public static String image;
    MyGLActivity_sport1.view_MyGLActivity_sport1 view;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        view = new MyGLActivity_sport1.view_MyGLActivity_sport1(this);
    ...
    public static class Cubere_MyGLActivity_sport1 implements GLSurfaceView.Renderer {
...
//	float touchedY = 0;
         ...
         */
        public Cubere_MyGLActivity_sport1(MyGLActivity_sport1.view_MyGLActivity_sport1 view_MyGLActivity_sport1)
        {
            mActivityContext = view_MyGLActivity_sport1;
...
//		// Position the eye behind the origin.
            ...
            if (mProgramHandle != 0)
            {
                ...
                mTextureDataHandle0 = loadTexture(mActivityContext, R.mipmap.j);
                mTextureDataHandle1 = loadTexture(mActivityContext, R.mipmap.k);
                mTextureDataHandle2 = loadTexture(mActivityContext, R.mipmap.mo);
                mTextureDataHandle3 = loadTexture(mActivityContext, R.mipmap.h);
                mTextureDataHandle4 = loadTexture(mActivityContext, R.mipmap.l);
                mTextureDataHandle5 = loadTexture(mActivityContext, R.mipmap.h);
...
//*each face of the cube is drawn using 2 triangles. so 2*3=6 lines
    ...
    public class view_MyGLActivity_sport1 extends GLSurfaceView {

        float touchedX = 0;
        float touchedY = 0;
        com.example.alphashopproject.ui.threed.MyGLActivity_sport1.Cubere_MyGLActivity_sport1 renderer;
        public view_MyGLActivity_sport1(Context context) {
            super(context);
            setEGLContextClientVersion(2);
            setRenderer(renderer = new com.example.alphashopproject.ui.threed.MyGLActivity_sport1.Cubere_MyGLActivity_sport1(this));
        }
