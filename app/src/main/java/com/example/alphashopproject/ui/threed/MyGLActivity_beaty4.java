...
public class MyGLActivity_beaty4 extends Activity {
    public static String image;
    MyGLActivity_beaty4.view_MyGLActivity_beaty4 view;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        view = new MyGLActivity_beaty4.view_MyGLActivity_beaty4(this);
    ...
    public static class Cubere_MyGLActivity_beaty4 implements GLSurfaceView.Renderer {
...
//	float touchedY = 0;
         ...
         */
        public Cubere_MyGLActivity_beaty4(MyGLActivity_beaty4.view_MyGLActivity_beaty4 view_MyGLActivity_beaty4)
        {
            mActivityContext = view_MyGLActivity_beaty4;
...
//		// Position the eye behind the origin.
            ...
            if (mProgramHandle != 0)
            {
                ...
                mTextureDataHandle0 = loadTexture(mActivityContext, R.mipmap.bytefourth);
                mTextureDataHandle1 = loadTexture(mActivityContext, R.mipmap.bytefourth);
                mTextureDataHandle2 = loadTexture(mActivityContext, R.mipmap.bytefourth);
                mTextureDataHandle3 = loadTexture(mActivityContext, R.mipmap.bytefourth);
                mTextureDataHandle4 = loadTexture(mActivityContext, R.mipmap.bytefourth);
                mTextureDataHandle5 = loadTexture(mActivityContext, R.mipmap.bytefourth);
...
//*each face of the cube is drawn using 2 triangles. so 2*3=6 lines
    ...
    public class view_MyGLActivity_beaty4 extends GLSurfaceView {

        float touchedX = 0;
        float touchedY = 0;
        com.example.alphashopproject.ui.threed.MyGLActivity_beaty4.Cubere_MyGLActivity_beaty4 renderer;
        public view_MyGLActivity_beaty4(Context context) {
            super(context);
            setEGLContextClientVersion(2);
            setRenderer(renderer = new com.example.alphashopproject.ui.threed.MyGLActivity_beaty4.Cubere_MyGLActivity_beaty4(this));
        }
