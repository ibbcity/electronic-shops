...
public class MyGLActivitybeat extends Activity {
    public static String image;
    MyGLActivitybeat.view_MyGLActivitybeat view;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        view = new MyGLActivitybeat.view_MyGLActivitybeat(this);
    ...
    public static class Cubere_MyGLActivitybeat implements GLSurfaceView.Renderer {
...
//	float touchedY = 0;
         ...
         */
        public Cubere_MyGLActivitybeat(MyGLActivitybeat.view_MyGLActivitybeat view_MyGLActivitybeat)
        {
            mActivityContext = view_MyGLActivitybeat;
...
//		// Position the eye behind the origin.
            ...
            if (mProgramHandle != 0)
            {
                ...
                mTextureDataHandle0 = loadTexture(mActivityContext, R.mipmap.toys);
                mTextureDataHandle1 = loadTexture(mActivityContext, R.mipmap.toys);
                mTextureDataHandle2 = loadTexture(mActivityContext, R.mipmap.toys);
                mTextureDataHandle3 = loadTexture(mActivityContext, R.mipmap.toys);
                mTextureDataHandle4 = loadTexture(mActivityContext, R.mipmap.toys);
                mTextureDataHandle5 = loadTexture(mActivityContext, R.mipmap.toys);
...
//*each face of the cube is drawn using 2 triangles. so 2*3=6 lines
    ...
    public class view_MyGLActivitybeat extends GLSurfaceView {

        float touchedX = 0;
        float touchedY = 0;
        com.example.alphashopproject.ui.threed.MyGLActivitybeat.Cubere_MyGLActivitybeat renderer;
        public view_MyGLActivitybeat(Context context) {
            super(context);
            setEGLContextClientVersion(2);
            setRenderer(renderer = new com.example.alphashopproject.ui.threed.MyGLActivitybeat.Cubere_MyGLActivitybeat(this));
        }
