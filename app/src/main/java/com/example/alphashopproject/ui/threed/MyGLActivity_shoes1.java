...
public class MyGLActivity_shoes1 extends Activity {
    public static String image;
    MyGLActivity_shoes1.view_MyGLActivity_shoes1 view;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        view = new MyGLActivity_shoes1.view_MyGLActivity_shoes1(this);
    ...
    public static class Cubere_MyGLActivity_shoes1 implements GLSurfaceView.Renderer {
...
//	float touchedY = 0;
         ...
         */
        public Cubere_MyGLActivity_shoes1(MyGLActivity_shoes1.view_MyGLActivity_shoes1 view_MyGLActivity_shoes1)
        {
            mActivityContext = view_MyGLActivity_shoes1;
...
//		// Position the eye behind the origin.
            ...
            if (mProgramHandle != 0)
            {
                ...
                mTextureDataHandle0 = loadTexture(mActivityContext, R.mipmap.shoes1);
                mTextureDataHandle1 = loadTexture(mActivityContext, R.mipmap.shoes1);
                mTextureDataHandle2 = loadTexture(mActivityContext, R.mipmap.shoes1);
                mTextureDataHandle3 = loadTexture(mActivityContext, R.mipmap.shoes1);
                mTextureDataHandle4 = loadTexture(mActivityContext, R.mipmap.shoes1);
                mTextureDataHandle5 = loadTexture(mActivityContext, R.mipmap.shoes1);
...
//*each face of the cube is drawn using 2 triangles. so 2*3=6 lines
    ...
    public class view_MyGLActivity_shoes1 extends GLSurfaceView {

        float touchedX = 0;
        float touchedY = 0;
        com.example.alphashopproject.ui.threed.MyGLActivity_shoes1.Cubere_MyGLActivity_shoes1 renderer;
        public view_MyGLActivity_shoes1(Context context) {
            super(context);
            setEGLContextClientVersion(2);
            setRenderer(renderer = new com.example.alphashopproject.ui.threed.MyGLActivity_shoes1.Cubere_MyGLActivity_shoes1(this));
        }
