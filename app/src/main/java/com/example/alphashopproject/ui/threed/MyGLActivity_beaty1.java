...
public class MyGLActivity_beaty1 extends Activity {
    public static String image;
    MyGLActivity_beaty1.view_MyGLActivity_beaty1 view;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        view = new MyGLActivity_beaty1.view_MyGLActivity_beaty1(this);
    ...
    public static class Cubere_MyGLActivity_beaty1 implements GLSurfaceView.Renderer {
...
//	float touchedY = 0;
         ...
         */
        public Cubere_MyGLActivity_beaty1(MyGLActivity_beaty1.view_MyGLActivity_beaty1 view_MyGLActivity_beaty1)
        {
            mActivityContext = view_MyGLActivity_beaty1;
...
//		// Position the eye behind the origin.
            ...
            if (mProgramHandle != 0)
            {
                ...
                mTextureDataHandle0 = loadTexture(mActivityContext, R.mipmap.eccs);
                mTextureDataHandle1 = loadTexture(mActivityContext, R.mipmap.eccs);
                mTextureDataHandle2 = loadTexture(mActivityContext, R.mipmap.eccs);
                mTextureDataHandle3 = loadTexture(mActivityContext, R.mipmap.eccs);
                mTextureDataHandle4 = loadTexture(mActivityContext, R.mipmap.eccs);
                mTextureDataHandle5 = loadTexture(mActivityContext, R.mipmap.eccs);
...
//*each face of the cube is drawn using 2 triangles. so 2*3=6 lines
    ...
    public class view_MyGLActivity_beaty1 extends GLSurfaceView {

        float touchedX = 0;
        float touchedY = 0;
        com.example.alphashopproject.ui.threed.MyGLActivity_beaty1.Cubere_MyGLActivity_beaty1 renderer;
        public view_MyGLActivity_beaty1(Context context) {
            super(context);
            setEGLContextClientVersion(2);
            setRenderer(renderer = new com.example.alphashopproject.ui.threed.MyGLActivity_beaty1.Cubere_MyGLActivity_beaty1(this));
        }
