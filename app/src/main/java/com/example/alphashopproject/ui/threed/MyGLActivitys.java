...
public class MyGLActivitys extends Activity {
    public static String image;
    MyGLActivitys.view_MyGLActivitys view;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        view = new MyGLActivitys.view_MyGLActivitys(this);
    ...
    public static class Cubere_MyGLActivitys implements GLSurfaceView.Renderer {
...
//	float touchedY = 0;
         ...
         */
        public Cubere_MyGLActivitys(MyGLActivitys.view_MyGLActivitys view_MyGLActivitys)
        {
            mActivityContext = view_MyGLActivitys;
...
//		// Position the eye behind the origin.
            ...
            if (mProgramHandle != 0)
            {
                ...
                mTextureDataHandle0 = loadTexture(mActivityContext, R.mipmap.silicon);
                mTextureDataHandle1 = loadTexture(mActivityContext, R.mipmap.silicon);
                mTextureDataHandle2 = loadTexture(mActivityContext, R.mipmap.silicon);
                mTextureDataHandle3 = loadTexture(mActivityContext, R.mipmap.silicon);
                mTextureDataHandle4 = loadTexture(mActivityContext, R.mipmap.silicon);
                mTextureDataHandle5 = loadTexture(mActivityContext, R.mipmap.silicon);
...
//*each face of the cube is drawn using 2 triangles. so 2*3=6 lines
    ...
    public class view_MyGLActivitys extends GLSurfaceView {

        float touchedX = 0;
        float touchedY = 0;
        com.example.alphashopproject.ui.threed.MyGLActivitys.Cubere_MyGLActivitys renderer;
        public view_MyGLActivitys(Context context) {
            super(context);
            setEGLContextClientVersion(2);
            setRenderer(renderer = new com.example.alphashopproject.ui.threed.MyGLActivitys.Cubere_MyGLActivitys(this));
        }
