...
public class MyGLActivity_shoes3 extends Activity {
    public static String image;
    MyGLActivity_shoes3.view_MyGLActivity_shoes3 view;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        view = new MyGLActivity_shoes3.view_MyGLActivity_shoes3(this);
    ...
    public static class Cubere_MyGLActivity_shoes3 implements GLSurfaceView.Renderer {
...
//	float touchedY = 0;
         ...
         */
        public Cubere_MyGLActivity_shoes3(MyGLActivity_shoes3.view_MyGLActivity_shoes3 view_MyGLActivity_shoes3)
        {
            mActivityContext = view_MyGLActivity_shoes3;
...
//		// Position the eye behind the origin.
            ...
            if (mProgramHandle != 0)
            {
                ...
                mTextureDataHandle0 = loadTexture(mActivityContext, R.mipmap.shos3);
                mTextureDataHandle1 = loadTexture(mActivityContext, R.mipmap.shos3);
                mTextureDataHandle2 = loadTexture(mActivityContext, R.mipmap.shos3);
                mTextureDataHandle3 = loadTexture(mActivityContext, R.mipmap.shos3);
                mTextureDataHandle4 = loadTexture(mActivityContext, R.mipmap.shos3);
                mTextureDataHandle5 = loadTexture(mActivityContext, R.mipmap.shos3);
...
//*each face of the cube is drawn using 2 triangles. so 2*3=6 lines
    ...
    public class view_MyGLActivity_shoes3 extends GLSurfaceView {

        float touchedX = 0;
        float touchedY = 0;
        com.example.alphashopproject.ui.threed.MyGLActivity_shoes3.Cubere_MyGLActivity_shoes3 renderer;
        public view_MyGLActivity_shoes3(Context context) {
            super(context);
            setEGLContextClientVersion(2);
            setRenderer(renderer = new com.example.alphashopproject.ui.threed.MyGLActivity_shoes3.Cubere_MyGLActivity_shoes3(this));
        }
