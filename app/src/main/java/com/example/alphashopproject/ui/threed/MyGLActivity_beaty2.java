...
public class MyGLActivity_beaty2 extends Activity {
    public static String image;
    MyGLActivity_beaty2.view_MyGLActivity_beaty2 view;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        view = new MyGLActivity_beaty2.view_MyGLActivity_beaty2(this);
    ...
    public static class Cubere_MyGLActivity_beaty2 implements GLSurfaceView.Renderer {
...
//	float touchedY = 0;
         ...
         */
        public Cubere_MyGLActivity_beaty2(MyGLActivity_beaty2.view_MyGLActivity_beaty2 view_MyGLActivity_beaty2)
        {
            mActivityContext = view_MyGLActivity_beaty2;
...
//		// Position the eye behind the origin.
            ...
            if (mProgramHandle != 0)
            {
                ...
                mTextureDataHandle0 = loadTexture(mActivityContext, R.mipmap.byttow);
                mTextureDataHandle1 = loadTexture(mActivityContext, R.mipmap.byttow);
                mTextureDataHandle2 = loadTexture(mActivityContext, R.mipmap.byttow);
                mTextureDataHandle3 = loadTexture(mActivityContext, R.mipmap.byttow);
                mTextureDataHandle4 = loadTexture(mActivityContext, R.mipmap.byttow);
                mTextureDataHandle5 = loadTexture(mActivityContext, R.mipmap.byttow);
...
//*each face of the cube is drawn using 2 triangles. so 2*3=6 lines
    ...
    public class view_MyGLActivity_beaty2 extends GLSurfaceView {

        float touchedX = 0;
        float touchedY = 0;
        com.example.alphashopproject.ui.threed.MyGLActivity_beaty2.Cubere_MyGLActivity_beaty2 renderer;
        public view_MyGLActivity_beaty2(Context context) {
            super(context);
            setEGLContextClientVersion(2);
            setRenderer(renderer = new com.example.alphashopproject.ui.threed.MyGLActivity_beaty2.Cubere_MyGLActivity_beaty2(this));
        }
