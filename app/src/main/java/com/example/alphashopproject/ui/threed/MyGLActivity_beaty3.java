...
public class MyGLActivity_beaty3 extends Activity {
    public static String image;
    MyGLActivity_beaty3.view_MyGLActivity_beaty3 view;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        view = new MyGLActivity_beaty3.view_MyGLActivity_beaty3(this);
    ...
    public static class Cubere_MyGLActivity_beaty3 implements GLSurfaceView.Renderer {
...
//	float touchedY = 0;
         ...
         */
        public Cubere_MyGLActivity_beaty3(MyGLActivity_beaty3.view_MyGLActivity_beaty3 view_MyGLActivity_beaty3)
        {
            mActivityContext = view_MyGLActivity_beaty3;
...
//		// Position the eye behind the origin.
            ...
            if (mProgramHandle != 0)
            {
                ...
                mTextureDataHandle0 = loadTexture(mActivityContext, R.mipmap.byt3);
                mTextureDataHandle1 = loadTexture(mActivityContext, R.mipmap.byt3);
                mTextureDataHandle2 = loadTexture(mActivityContext, R.mipmap.byt3);
                mTextureDataHandle3 = loadTexture(mActivityContext, R.mipmap.byt3);
                mTextureDataHandle4 = loadTexture(mActivityContext, R.mipmap.byt3);
                mTextureDataHandle5 = loadTexture(mActivityContext, R.mipmap.byt3);
...
//*each face of the cube is drawn using 2 triangles. so 2*3=6 lines
    ...
    public class view_MyGLActivity_beaty3 extends GLSurfaceView {

        float touchedX = 0;
        float touchedY = 0;
        com.example.alphashopproject.ui.threed.MyGLActivity_beaty3.Cubere_MyGLActivity_beaty3 renderer;
        public view_MyGLActivity_beaty3(Context context) {
            super(context);
            setEGLContextClientVersion(2);
            setRenderer(renderer = new com.example.alphashopproject.ui.threed.MyGLActivity_beaty3.Cubere_MyGLActivity_beaty3(this));
        }
