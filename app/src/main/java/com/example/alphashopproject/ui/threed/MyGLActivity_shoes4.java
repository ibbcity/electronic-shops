...
public class MyGLActivity_shoes4 extends Activity {
    public static String image;
    MyGLActivity_shoes4.view_MyGLActivity_shoes4 view;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        view = new MyGLActivity_shoes4.view_MyGLActivity_shoes4(this);
    ...
    public static class Cubere_MyGLActivity_shoes4 implements GLSurfaceView.Renderer {
...
//	float touchedY = 0;
         ...
         */
        public Cubere_MyGLActivity_shoes4(MyGLActivity_shoes4.view_MyGLActivity_shoes4 view_MyGLActivity_shoes4)
        {
            mActivityContext = view_MyGLActivity_shoes4;
...
//		// Position the eye behind the origin.
            ...
            if (mProgramHandle != 0)
            {
                ...
                mTextureDataHandle0 = loadTexture(mActivityContext, R.mipmap.shoesforth);
                mTextureDataHandle1 = loadTexture(mActivityContext, R.mipmap.shoesforth);
                mTextureDataHandle2 = loadTexture(mActivityContext, R.mipmap.shoesforth);
                mTextureDataHandle3 = loadTexture(mActivityContext, R.mipmap.shoesforth);
                mTextureDataHandle4 = loadTexture(mActivityContext, R.mipmap.shoesforth);
                mTextureDataHandle5 = loadTexture(mActivityContext, R.mipmap.shoesforth);
...
//*each face of the cube is drawn using 2 triangles. so 2*3=6 lines
    ...
    public class view_MyGLActivity_shoes4 extends GLSurfaceView {

        float touchedX = 0;
        float touchedY = 0;
        com.example.alphashopproject.ui.threed.MyGLActivity_shoes4.Cubere_MyGLActivity_shoes4 renderer;
        public view_MyGLActivity_shoes4(Context context) {
            super(context);
            setEGLContextClientVersion(2);
            setRenderer(renderer = new com.example.alphashopproject.ui.threed.MyGLActivity_shoes4.Cubere_MyGLActivity_shoes4(this));
        }
