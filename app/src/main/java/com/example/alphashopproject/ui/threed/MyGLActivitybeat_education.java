package com.example.alphashopproject.ui.threed;
...
public class MyGLActivitybeat_education extends Activity {
    public static String image;
    MyGLActivitybeat_education.view_MyGLActivitybeat_education view;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        view = new MyGLActivitybeat_education.view_MyGLActivitybeat_education(this);
    ...
    public static class Cubere_MyGLActivitybeat_education implements GLSurfaceView.Renderer {
...
//	float touchedY = 0;
         ...
         */
        public Cubere_MyGLActivitybeat_education(MyGLActivitybeat_education.view_MyGLActivitybeat_education view_MyGLActivitybeat_education)
        {
            mActivityContext = view_MyGLActivitybeat_education;
...
//		// Position the eye behind the origin.
            ...
            if (mProgramHandle != 0)
            {
                ...
                mTextureDataHandle0 = loadTexture(mActivityContext, R.mipmap.toys3);
                mTextureDataHandle1 = loadTexture(mActivityContext, R.mipmap.toys3);
                mTextureDataHandle2 = loadTexture(mActivityContext, R.mipmap.toys3);
                mTextureDataHandle3 = loadTexture(mActivityContext, R.mipmap.toys3);
                mTextureDataHandle4 = loadTexture(mActivityContext, R.mipmap.toys3);
                mTextureDataHandle5 = loadTexture(mActivityContext, R.mipmap.toys3);
...
//*each face of the cube is drawn using 2 triangles. so 2*3=6 lines
    ...
    public class view_MyGLActivitybeat_education extends GLSurfaceView {

        float touchedX = 0;
        float touchedY = 0;
        com.example.alphashopproject.ui.threed.MyGLActivitybeat_education.Cubere_MyGLActivitybeat_education renderer;
        public view_MyGLActivitybeat_education(Context context) {
            super(context);
            setEGLContextClientVersion(2);
            setRenderer(renderer = new com.example.alphashopproject.ui.threed.MyGLActivitybeat_education.Cubere_MyGLActivitybeat_education(this));
        }
