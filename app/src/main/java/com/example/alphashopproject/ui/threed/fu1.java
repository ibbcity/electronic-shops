...
public class fu1 extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        view = new fu1.view_bookes1(this);
...
//	float touchedY = 0;
         ...
         */
        public Cubere_bookes1(fu1.view_bookes1 view_bookes1)
        {
...
//		// Position the eye behind the origin.
            ...
            if (mProgramHandle != 0)
            {
                ...
                mTextureDataHandle0 = loadTexture(mActivityContext, R.mipmap.fu1);
                mTextureDataHandle1 = loadTexture(mActivityContext, R.mipmap.fu1);
                mTextureDataHandle2 = loadTexture(mActivityContext, R.mipmap.fu1);
                mTextureDataHandle3 = loadTexture(mActivityContext, R.mipmap.fu1);
                mTextureDataHandle4 = loadTexture(mActivityContext, R.mipmap.fu1);
                mTextureDataHandle5 = loadTexture(mActivityContext, R.mipmap.fu1);
...
//*each face of the cube is drawn using 2 triangles. so 2*3=6 lines
    ...
    public class view_bookes1 extends GLSurfaceView {
        ...
        float touchedX = 0;
        float touchedY = 0;
        com.example.alphashopproject.ui.threed.fu1.Cubere_bookes1 renderer;
        public view_bookes1(Context context) {
            super(context);
            setEGLContextClientVersion(2);
            setRenderer(renderer = new com.example.alphashopproject.ui.threed.fu1.Cubere_bookes1(this));
        }
