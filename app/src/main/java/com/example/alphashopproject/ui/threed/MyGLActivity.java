...
/**
 * Created by Abdualftah on 4/15/2022.
 */

public class MyGLActivity extends Activity {
    public static String image;
    MyGLActivity.view_MyGLActivity view;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        view = new MyGLActivity.view_MyGLActivity(this);
    ...
    public static class Cubere_MyGLActivity implements GLSurfaceView.Renderer {
...
//	float touchedY = 0;
         ...
         */
        public Cubere_MyGLActivity(MyGLActivity.view_MyGLActivity view_MyGLActivity)
        {
            mActivityContext = view_MyGLActivity;
...
//		// Position the eye behind the origin.
            ...
            if (mProgramHandle != 0)
            {
                ...
                mTextureDataHandle0 = loadTexture(mActivityContext, R.mipmap.dinasor);
                mTextureDataHandle1 = loadTexture(mActivityContext, R.mipmap.dinasor);
                mTextureDataHandle2 = loadTexture(mActivityContext, R.mipmap.dinasor);
                mTextureDataHandle3 = loadTexture(mActivityContext, R.mipmap.dinasor);
                mTextureDataHandle4 = loadTexture(mActivityContext, R.mipmap.dinasor);
                mTextureDataHandle5 = loadTexture(mActivityContext, R.mipmap.dinasor);
...
//*each face of the cube is drawn using 2 triangles. so 2*3=6 lines
    ...
    public class view_MyGLActivity extends GLSurfaceView {

        float touchedX = 0;
        float touchedY = 0;
        com.example.alphashopproject.ui.threed.MyGLActivity.Cubere_MyGLActivity renderer;
        public view_MyGLActivity(Context context) {
            super(context);
            setEGLContextClientVersion(2);
            setRenderer(renderer = new com.example.alphashopproject.ui.threed.MyGLActivity.Cubere_MyGLActivity(this));
        }
